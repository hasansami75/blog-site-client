  ...
  return (
    <footer class="page-footer container pt-4">
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-md-0 mb-3 ">
            ...
            <ul class="list-unstyled">
              <li>
                <a href="#!" class="text-lg text-white font-weight-bold text-decoration-none">Thakurpara, Comilla, Bangladesh</a>
              </li><br></br>
              <li>
                <a href="#!" class="text-lg text-white font-weight-bold text-decoration-none">mehedihasan3175@gmail.com</a>
              </li><br></br>
              <li>
                <a href="#!" class="text-lg text-white text-decoration-none font-weight-bold">+8801686687843</a>
              </li>
      ...
      <div class="footer-copyright text-center text-white py-3">
            © 2021 Copyright:
            <a href="https://hasansami75.netlify.app/" class="text-blue hover:text-blue text-decoration-none"> Mahedi Hassan Sami</a>
          </div>
    </footer>
  );
};
